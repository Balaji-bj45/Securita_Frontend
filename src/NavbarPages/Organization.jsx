                ...
                {filteredOrgs.map((org, i) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2 mt-6">
                      ...
                      <button
                        onClick={() => {
                          setSelectedOrgForAdmin(org._id);
                  ...
                  <form onSubmit={handleAddAdmin} className="space-y-5">
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white py-3 rounded-xl font-medium flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all duration-200"
                      >
                        {loading ? (
                          <>
                            <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
